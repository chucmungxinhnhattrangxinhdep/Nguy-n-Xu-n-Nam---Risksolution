...
import pocad.network.ClassificationResults;
import pocad.network.PacketClassifier;
...
import ui.risksolution.pocadUI;

public class TestMcPAD {

	public  void runTest() {

		String rootDirectory = "C:\\Users\\Nam\\Documents\\NetBeansProjects\\RiskSolution\\RootDirectory";
                String pcapFileSourceName = "data.pcap";
		String pcapSource = "C:\\Users\\Nam\\Documents\\NetBeansProjects\\RiskSolution\\RootDirectory\\pcap\\";
                pcapSource =  pcapSource.concat(pcapFileSourceName);
		String pcapFilesDir = null;
		String pcapFilter = "";
		String combinationRule = "MAX";
		int numOfPackets = -1;
		...
		*/
		if(rootDirectory==null || (pcapSource==null && pcapFilesDir==null) ||  combinationRule==null) {
			printUsage();
			System.exit(1);
		}
		...
		if(pcapSource!=null) {
			...
			System.out.println("Số hành vi tấn công" + detectedMAX + "/" + pcaps.length);
		}
	}
