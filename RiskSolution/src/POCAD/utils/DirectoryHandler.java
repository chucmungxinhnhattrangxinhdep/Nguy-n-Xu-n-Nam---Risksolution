...
public class DirectoryHandler {
	...
	private void makeAllDirs() {
		...
		System.out.println("---------------------------------------");
		System.out.println("> Tap goi tin can phan tich = " + pcapDir);
		System.out.println("> Tap huan luyen = " + trainingSetDir);
	...
	public File getClusterConfigFile() {
		return new File(rootDirectory, CLUSTERING_CONFIG_FILE);
	}
